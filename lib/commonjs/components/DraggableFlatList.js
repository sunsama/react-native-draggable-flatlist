...
var _jsxFileName =
  "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx";
...
function DraggableFlatListInner(props) {
  ...
  var _useAnimatedValues = (0, _animatedValueContext.useAnimatedValues)(),
    ...
    rawTranslate = _useAnimatedValues.rawTranslate,
    triggerReset = _useAnimatedValues.triggerReset,
  ...
  (0, _reactNativeReanimated.useAnimatedReaction)(
    (function () {
      ...
      _f.__location =
        "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx (234:4)";
      return _f;
    })(),
    (function () {
      ...
      _f.__location =
        "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx (237:4)";
      return _f;
    })(),
  ...
  (0, _reactNativeReanimated.useDerivedValue)(
    (function () {
      ...
      _f.asString =
        "function _f(){const{triggerReset,runOnJS,reset}=jsThis._closure;{if(triggerReset.value){runOnJS(reset)();triggerReset.value=false;}}}";
      _f.__workletHash = 4268021600354;
      _f.__location =
        "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx (253:18)";
      return _f;
    })(),
    []
  );
  var panGesture = _reactNativeGestureHandler.Gesture.Pan()
    .onBegin(
      (function () {
        ...
        _f.__location =
          "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx (261:13)";
        return _f;
      })()
    )
    .onUpdate(
      (function () {
        var _f = function _f(evt) {
          ...
          touchTranslate.value = horizontalAnim.value
            ? evt.translationX
            : evt.translationY;
          rawTranslate.value = { x: evt.x, y: evt.y };
        };
        _f._closure = {
          gestureDisabled: gestureDisabled,
          panGestureState: panGestureState,
        ...
        _f.asString =
          "function _f(evt){const{gestureDisabled,panGestureState,touchTranslate,horizontalAnim,rawTranslate}=jsThis._closure;{if(gestureDisabled.value)return;panGestureState.value=evt.state;touchTranslate.value=horizontalAnim.value?evt.translationX:evt.translationY;rawTranslate.value={x:evt.x,y:evt.y};}}";
        _f.__workletHash = 1170720875244;
        _f.__location =
          "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx (266:14)";
        return _f;
      })()
    )
    .onEnd(
      (function () {
        var _f = function _f(evt) {
          ...
          touchTranslate.value = (0, _reactNativeReanimated.withSpring)(
            ...
            (function () {
              ...
              _f.__location =
                "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx (300:8)";
              return _f;
            })()
          );
        };
        ...
        _f.asString =
          "function _f(evt){const{gestureDisabled,isTouchActiveNative,horizontalAnim,touchTranslate,autoScrollDistance,rawTranslate,panGestureState,activeIndexAnim,disabled,runOnJS,onRelease,placeholderOffset,activeCellOffset,withSpring,animationConfigRef,onDragEnd,spacerIndexAnim}=jsThis._closure;{if(gestureDisabled.value)return;isTouchActiveNative.value=false;const translation=horizontalAnim.value?evt.translationX:evt.translationY;touchTranslate.value=translation+autoScrollDistance.value;rawTranslate.value={x:evt.x,y:evt.y};panGestureState.value=evt.state;if(activeIndexAnim.value===-1||disabled.value)return;disabled.value=true;runOnJS(onRelease)(activeIndexAnim.value);const springTo=placeholderOffset.value-activeCellOffset.value;touchTranslate.value=withSpring(springTo,animationConfigRef.current,function(){runOnJS(onDragEnd)({from:activeIndexAnim.value,to:spacerIndexAnim.value});disabled.value=false;});}}";
        _f.__workletHash = 6352848747956;
        _f.__location =
          "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx (277:11)";
        return _f;
      })()
    )
    .onTouchesDown(
      (function () {
        ...
        _f.__location =
          "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx (309:19)";
        return _f;
      })()
    )
    .onTouchesUp(
      (function () {
        ...
        _f.__location =
          "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx (312:17)";
        return _f;
      })()
    );
  ...
  var scrollHandler = (0, _reactNativeReanimated.useAnimatedScrollHandler)(
    {
      onScroll: (function () {
        ...
        _f.__location =
          "/Users/josephcallaars/IdeaProjects/react-native-draggable-flatlist/src/components/DraggableFlatList.tsx (334:16)";
        return _f;
      })(),
    },
    [horizontalAnim]
  ...
  return _react.default.createElement(
    _draggableFlatListContext.default,
    {
      ...
      __self: this,
      __source: { fileName: _jsxFileName, lineNumber: 362, columnNumber: 5 },
    },
    _react.default.createElement(
      _reactNativeGestureHandler.GestureDetector,
      {
        gesture: panGesture,
        __self: this,
        __source: { fileName: _jsxFileName, lineNumber: 368, columnNumber: 7 },
      },
      _react.default.createElement(
...
function DraggableFlatList(props, ref) {
  return _react.default.createElement(
    ...
    (0, _extends2.default)({}, props, {
      __self: this,
      __source: { fileName: _jsxFileName, lineNumber: 410, columnNumber: 5 },
    }),
    _react.default.createElement(
      _animatedValueContext.default,
      {
        __self: this,
        __source: { fileName: _jsxFileName, lineNumber: 411, columnNumber: 7 },
      },
      _react.default.createElement(
        _refContext.default,
        {
